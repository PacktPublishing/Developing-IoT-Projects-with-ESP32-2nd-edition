...
struct ReadingsFb;
struct ReadingsFbBuilder;
struct ReadingsFbT;

inline const flatbuffers::TypeTable *ReadingFbTypeTable();

inline const flatbuffers::TypeTable *ReadingsFbTypeTable();
...
struct ReadingsFbT : public flatbuffers::NativeTable {
  typedef ReadingsFb TableType;
  std::string location{};
  std::vector<std::unique_ptr<app::ReadingFbT>> readings{};
  ReadingsFbT() = default;
  ReadingsFbT(const ReadingsFbT &o);
  ReadingsFbT(ReadingsFbT&&) FLATBUFFERS_NOEXCEPT = default;
  ReadingsFbT &operator=(ReadingsFbT o) FLATBUFFERS_NOEXCEPT;
};

struct ReadingsFb FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ReadingsFbT NativeTableType;
  typedef ReadingsFbBuilder Builder;
  static const flatbuffers::TypeTable *MiniReflectTypeTable() {
    return ReadingsFbTypeTable();
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_LOCATION = 4,
    VT_READINGS = 6
  ...
  ReadingsFbT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(ReadingsFbT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<ReadingsFb> Pack(flatbuffers::FlatBufferBuilder &_fbb, const ReadingsFbT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct ReadingsFbBuilder {
  typedef ReadingsFb Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_location(flatbuffers::Offset<flatbuffers::String> location) {
    fbb_.AddOffset(ReadingsFb::VT_LOCATION, location);
  }
  void add_readings(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<app::ReadingFb>>> readings) {
    fbb_.AddOffset(ReadingsFb::VT_READINGS, readings);
  }
  explicit ReadingsFbBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<ReadingsFb> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ReadingsFb>(end);
    return o;
  }
};

inline flatbuffers::Offset<ReadingsFb> CreateReadingsFb(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> location = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<app::ReadingFb>>> readings = 0) {
  ReadingsFbBuilder builder_(_fbb);
  builder_.add_readings(readings);
  builder_.add_location(location);
  return builder_.Finish();
}

inline flatbuffers::Offset<ReadingsFb> CreateReadingsFbDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return app::CreateReadingsFb(
      _fbb,
      location__,
      readings__);
}

flatbuffers::Offset<ReadingsFb> CreateReadingsFb(flatbuffers::FlatBufferBuilder &_fbb, const ReadingsFbT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline ReadingsFbT::ReadingsFbT(const ReadingsFbT &o)
      : location(o.location) {
...
inline ReadingsFbT &ReadingsFbT::operator=(ReadingsFbT o) FLATBUFFERS_NOEXCEPT {
  std::swap(location, o.location);
  std::swap(readings, o.readings);
  return *this;
}

inline ReadingsFbT *ReadingsFb::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<ReadingsFbT>(new ReadingsFbT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void ReadingsFb::UnPackTo(ReadingsFbT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
...
inline flatbuffers::Offset<ReadingsFb> ReadingsFb::Pack(flatbuffers::FlatBufferBuilder &_fbb, const ReadingsFbT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateReadingsFb(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<ReadingsFb> CreateReadingsFb(flatbuffers::FlatBufferBuilder &_fbb, const ReadingsFbT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const ReadingsFbT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline const app::ReadingsFb *GetReadingsFb(const void *buf) {
  return flatbuffers::GetRoot<app::ReadingsFb>(buf);
}

inline const app::ReadingsFb *GetSizePrefixedReadingsFb(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<app::ReadingsFb>(buf);
}

inline bool VerifyReadingsFbBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<app::ReadingsFb>(nullptr);
}

inline bool VerifySizePrefixedReadingsFbBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<app::ReadingsFb>(nullptr);
}

inline void FinishReadingsFbBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<app::ReadingsFb> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedReadingsFbBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<app::ReadingsFb> root) {
  fbb.FinishSizePrefixed(root);
}

inline std::unique_ptr<app::ReadingsFbT> UnPackReadingsFb(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<app::ReadingsFbT>(GetReadingsFb(buf)->UnPack(res));
}

inline std::unique_ptr<app::ReadingsFbT> UnPackSizePrefixedReadingsFb(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<app::ReadingsFbT>(GetSizePrefixedReadingsFb(buf)->UnPack(res));
}
