...
/* {{{ pre-tests */
#if defined(CONFIG_IDF_TARGET_ESP32) && defined(CONFIG_IDF_TARGET_ESP8266) && defined(CONFIG_IDF_TARGET_ESP32S3)
...
/* ESP32S2 4.x */
#if defined(CONFIG_IDF_TARGET_ESP32S3) && defined(ESP_IDF_VERSION_MAJOR)
