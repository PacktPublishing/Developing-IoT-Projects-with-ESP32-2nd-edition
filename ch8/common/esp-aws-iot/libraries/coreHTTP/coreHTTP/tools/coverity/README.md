...
This directory is made for the purpose of statically testing the MISRA C:2012 compliance of coreHTTP Library using
...
To that end, this directory provides a [configuration file](https://github.com/FreeRTOS/coreHTTP/blob/main/tools/coverity/misra.config) to use when
...
see the [MISRA.md](https://github.com/FreeRTOS/coreHTTP/blob/main/MISRA.md) file.
